      ...
      <div className="block m-auto bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <div className="items-center m-5 pb-10 pt-10">
          <div className="flex justify-between">
            ...
            <Link to={'/user/create'} className="inline-flex items-center px-4 py-2 text-sm ml-3 font-medium text-center text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-yellow-300 dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-green-800 mb-5">Create</Link>
                ...
                {users.map((user, id) => (
                  <tr key={user.id} className="border-b dark:border-neutral-500">
                    ...
                    <td className="whitespace-nowrap px-6 py-4">
                      <Link to={"/user/edit/" + user.id} className="px-4 py-2 bg-pink-500 rounded-lg mr-2 font-bold text-white">
                        Edit
                      </Link>
                      <Link to={`/user/${user.id}/show`}className="px-4 py-2 bg-blue-500 rounded-lg mr-2 font-bold text-white">
                        Show
                      </Link>
                      <button
                        type="button"
