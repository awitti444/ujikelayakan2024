import axios from "axios"; //melakukan proses HTTP request pada website dengan React JS.
import React, { useEffect, useState } from "react"; //useEffect ini akan berjalan saat pertama render dan saat terdapat sebuah re-render / pembaruan di komponennya.
import { Link, useLocation, useNavigate } from "react-router-dom"; //

export default function Navbar() {
    const [isLogin, setIsLogin] = useState(false); //State merupakan data yang dimiliki oleh sebuah komponen
